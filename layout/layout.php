...
<head>
    ...
    <title><?php echo (isset($PAGE_TITLE) && $PAGE_TITLE != null) ? $PAGE_TITLE . " - "  .$APPLICATION_NAME : $APPLICATION_NAME; ?></title>
    <meta name="description" content="<?php echo (isset($PAGE_DESCRIPTION) && $PAGE_DESCRIPTION != null) ? $PAGE_DESCRIPTION . " - "  .$APPLICATION_NAME : 'AcademiChain documentation'; ?>">
